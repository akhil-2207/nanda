...
function WhatDoWeDo() {
    return (
        <div id="who-we-are" className="h-fit md:px-4 py-10 min-h-[70vh] flexitems-center justify-center bg-primary-foreground">
            <div className="container mx-auto flex md:flex-col flex-col px-3">
                <div className="mb-10 border md:px-4 font-normal rounded-2xl border-primary p-2 md:p-8 md:hover:bg-secondary md:hover:shadow-lg transition-all duration-500 ease-in-out md:min-h-[300px]">
                    ...
                    <div className="flex gap-14 md:gap-0 md:flex-row py-6 md:py-0 flex-col justify-between">
                        <p className="text-base md:w-[60%] md:text-lg lg:text-xl leading-relaxed flex h-fit text-justify md:mt-6">
                            ...
                            With over, 15 farms, 3 feed mills, 5 hatcheries and 2 processing units, we bring healthy, tasty and farm- fresh chicken directly to your home.
                        </p>
                        <img src={COMPANY} alt="" className=" md:w-[400px] h-[250px] rounded-2xl -mt-10 md:mt-1 " />
                    </div>
                </div>
                <div className=" md:px-4 font-normal border rounded-2xl border-primary p-2 md:p-8 md:hover:bg-secondary md:hover:shadow-lg transition-all duration-500 ease-in-out md:min-h-[300px]">
                    <h2 className="text-2xl md:w-1/2 md:text-3xl lg:text-xl font-semibold -mb-2 mt-2 md:-mt-4 text-center">
                        Who Are We
                    </h2>
                    <div className="flex md:flex-row gap-14 md:gap-0 md:py-0 py-6 flex-col justify-between">
                        ...
                        It all began in the early 1960's when poultry farming was in its infancy. In 1963, our visionary founder P. S Nandakumar established Nanda Group in Bangalore, 
                        with a divine motto and a dedicated team to revolutionize the poultry business in India. He redefined the standards of poultry farming and production by setting up state of the art facilities across southern and western parts of India, 
