    ...
    return (
        <div id="who-we-are" className="h-fit px-4 py-10 min-h-[70vh] flex items-center justify-center bg-primary-foreground">
            <div className="container mx-auto flex md:flex-col flex-col">
                <div className="mb-10  md:px-4 font-normal border rounded-2xl border-primary p-2 md:p-8 hover:bg-primary hover:shadow-lg transition-all duration-700 ease-in-out md:min-h-[300px]">
